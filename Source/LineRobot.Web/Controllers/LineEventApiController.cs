...
namespace LineRobot.Web.Controllers
{
    [ApiController]
    [Route("[controller]/[action]")]
    public class LineEventApiController : ControllerBase
    {
        private readonly ILogger<LineEventApiController> logger;
        private readonly ILineBot lineBot;
        private readonly IServiceProvider serviceProvider;

        private readonly CryptographyService cryptographyService;

        public LineEventApiController(
            ILogger<LineEventApiController> logger,
            ILineBot lineBot,
        ...
        public async void Handle()
        {
            ...
            {
                var eventHandlers = serviceProvider.GetServices<ILineEventHandler>().Where(item => item.LineEventType == @event.EventType);
